              ...
              <TabPanel value={value} index={2} dir={theme.direction}>
                ...
                <div class="modal-right">
                  <div className="modal-title" sx={{ color: fontModal }}>
                    ...
                    <br />{" "}
                    <span className="position1">System Engineer (Present)</span>
                  </div>
                  <div className="modal-classification">
                    <ul className="ul-bullet">
                      <li>
                        Supporting day-to-day operations, following established
                        procedures.
                      </li>
                      <li>
                      ...
                      <li>
                        Identifying and communicating risks and critical points
                        to the manager.
                      </li>
                      <li>Strictly adhering to production protocols.</li>
                      <li>Independently designing and constructing modules.</li>
                      ...
                      <li>
                        Identifying and proposing improvements to work methods.
                      </li>
                      <li>
